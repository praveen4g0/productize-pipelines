...
### Setup 
* Execute `curl https://gist.githubusercontent.com/hrishin/90e7df87263c03801546ded814cd2947/raw/251b8a227b69392d89c8e0eeb83e024923099bcd/p12n-setup | bash`
...
5) Commit and push the CSV changes to `dist-git` repo. Build the `operator-metadata` image to publish the CSV manifest to `quay` application registry. Follo [Build Operator Meta](#build-operator-meta) section.
